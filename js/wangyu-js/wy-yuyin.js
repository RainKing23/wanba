...
var btn=document.querySelector('.wy-yuyin1 .yubtn .yintiao');
var text=document.querySelector('.wy-yuyin1 h1');
var zhuan=document.querySelector('.zhuan');
var lis= document.querySelectorAll('.wy-yuyin1 .tiao ul li div');
var speak= document.querySelector('.text-1 span');
var dask= document.querySelectorAll('.wy-dask')[0];
var dask2= document.querySelectorAll('.wy-dask')[1];
